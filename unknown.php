...
<header class="cf">					
	...
	<nav class="cf">
		<ul id="nav" class="sf-menu">
			...
			<li class="current-menu-item"><a href="unknown.php"><span>UNBEKANNT</span></a></li>
		...
		<div role="main" id="main" class="cf">
			...
			<div class="page-content">
	        	...
	        	<div class="entry-content cf">
	        		...
	        		<h2 class="heading">UNBEKANNT</h2>
	        		<p>Hier findes du alle Katzen, die noch kein Revier zugeordnet bekommen haben. Klicke auf das Bild um das zu ändern. Ein Revier setzt sich aus Straßennamen und Hausnummer zusammen.</p></br>
...
where c2.deleted = false and h.street is null
